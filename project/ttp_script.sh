...
if repo init --depth=1 -u $GIT/The-Pixel-Project/manifest.git -b fourteen-qpr3 --git-lfs; then
     echo -e "================================"
     ...
     if [ -d "$LOCAL" ]; then
         rm -rf $LOCAL/*
         if wget -O "$LOCAL/local_manifest.xml" https://raw.githubusercontent.com/$ARATA1/local_manifest/refs/heads/master/local_manifest_ttp.xml; then
             echo -e "================================"
             ...
             # Build rom
             source build/envsetup.sh; lunch aosp_surya-user; make installclean; make bacon
         else
             echo -e "================================"
